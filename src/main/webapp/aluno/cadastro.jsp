	...
	<div class="container">
	  ...
	  <form action="aluno" method="post">
	    ...
	    <div class="form-group">
	      <label>Nome:</label>
	      <input value="Alceu Lima" type="text" class="form-control" placeholder="Entre com o seu nome" name="nome">
	    </div>

	    <div class="form-group">
	      <label>Idade:</label>
	      <input value="32" type="text" class="form-control" placeholder="Entre com a sua idade" name="idade">
	    </div>
